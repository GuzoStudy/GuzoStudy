...
// Dashboard Stats (with API integration)
...
// Revenue and Earnings Data (with API integration)
export const fetchRevenueData = async () => {
  try {
    return await apiCall('/analytics/revenue');
  } catch (error) {
...
// Student Enrollment Data (with API integration)
export const fetchEnrollmentData = async () => {
  try {
    return await apiCall('/analytics/enrollment');
  } catch (error) {
    // Fallback to mock data
    return [
...
// Course Performance Data (with API integration)
export const fetchCoursePerformanceData = async () => {
  try {
    return await apiCall('/courses/performance');
  } catch (error) {
    // Fallback to mock data
    return [
...
// Live Classes Schedule (with API integration)
export const fetchLiveClassesData = async () => {
  try {
    return await apiCall('/live-classes');
  } catch (error) {
    // Fallback to mock data
    return [
      {
...
// Student Progress Data (with API integration)
export const fetchStudentProgressData = async () => {
  try {
    return await apiCall('/students/progress');
  } catch (error) {
    // Fallback to mock data
    return [
...
// Messages Data (with API integration)
...
// Recent Activities (with API integration)
export const fetchRecentActivities = async () => {
  try {
    return await apiCall('/dashboard/activities');
  } catch (error) {
    // Fallback to mock data
    return [
...
export const updateLiveClass = async (classId, classData) => {
  try {
    return await apiCall(`/live-classes/${classId}`, {
      method: 'PUT',
      body: JSON.stringify(classData),
    });
  } catch (error) {
...
export const fetchPaymentHistory = async () => {
  try {
    return await apiCall('/earnings/history');
  } catch (error) {
...
export const requestPayout = async (payoutData) => {
  try {
    return await apiCall('/payouts/request', {
      method: 'POST',
...
export const uploadProfilePhoto = async (photoFile) => {
  try {
    ...
    return await apiCall('/profile/upload-photo', {
      method: 'POST',
      body: formData,
...
// Legacy exports for backward compatibility (these will use the API functions)
