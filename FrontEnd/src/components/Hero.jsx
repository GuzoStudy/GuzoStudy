...
function Hero({ currentUser }) {
  ...
  const handlePrimaryClick = () => {
    if (currentUser) {
      ...
      navigate("/signup"); // signup for guests
    }
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              {currentUser
                ? "Welcome! Continue your journey of teaching and learning."
                : "Join live classes or explore on-demand courses."}
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              {/* Primary Button — changes after login */}
              <button
...
>
  {currentUser ? "Continue Learning" : "Get Started"}
          ...
          {/* Right Section (Graphic elements) */}
