...
// API setup
const API_KEY = "AIzaSyDXxBQiZDy8lhy831V5RxqTLqAlVbEA3qg";
...
const generateBotResponse = async (incomingMessageDiv) => {
  ...
  const requestOptions = {
    method: "POST",
    headers: { "Content-Type": "application/json" }, // Fixed 'Headers' to 'headers'
    body: JSON.stringify({
  ...
  try {
    ...
    // Extract and display bot's message
    ...
    // Reset user's data and remove thinking indicator and scroll to bottom
    userData.file = {};
...
messageInput.addEventListener("input", () => {
  ...
  document.querySelector(".chat-form").style.borderRadius = messageInput.scrollHeight > initialInputHeight ? "15px" : "32px"; // Fixed selector
});
...
// i have to  understand these whole mess withn one day and write it by my on way oth.....
